...
router.put('/member/:membershipId/photo', c.updateMemberPhoto); // edit the gym's photo of a member (owner / staff with canAddMember)
router.put('/member/:membershipId/profile', c.updateMemberProfile); // edit gym-registration details (email, DOB, address…)
